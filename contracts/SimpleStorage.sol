...
// adding the solidity version to start a smart contract
...
// to start defining our contract and it's a key word in solidity, you can thin of it as any class in javascript
// evrything inside is going to be the contents of this contract
...
contract SimpleStorage {
    ...
    // this is also another way to add a function to return this favoriteNumber
